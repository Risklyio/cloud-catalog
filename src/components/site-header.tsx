      ...
      <div className="mx-auto max-w-5xl">
        <div className="flex items-center gap-2 rounded-full border border-stone-200/90 bg-white/95 px-2 py-2 shadow-lg shadow-stone-300/25 backdrop-blur-md sm:gap-3 sm:px-3 sm:py-2.5">
          <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-2.5">
            ...
            <SiteNavMenu align="left" />
          </div>

          <Link
            href="/"
            className="ml-1 shrink-0 rounded-lg outline-none ring-[#6557ff] focus-visible:ring-2 focus-visible:ring-offset-2"
          >
            <Image
              src="/logo.png"
              alt="Cloudiscover.io"
              ...
              priority
              unoptimized
              className="h-8 w-auto max-w-[min(42vw,200px)] object-contain object-right sm:h-9"
            />
          </Link>
        </div>
      </div>
